function POO() {
    ...
    if ((valor == "Definição") || (valor == "definição") || (valor == "definicao") || (valor == "Definicao")) {
    ...
    else if ((valor == "Características") || (valor == "característica") || (valor == "caracteristicas") || (valor == "Caracteristicas")) {
    ...
    else if ((valor == "Pilares") || (valor == "pilares")) {
        ...
        img4.setAttribute("width", "80px");
        img5.setAttribute("src", "img/polimorfismo.png");
        img5.setAttribute("width", "80px");
        ...
        img.setAttribute("src", "img/instanciaEobjeto");
    ...
    else if ((valor == "Class") || (valor == "class")) {
    ...
    else if ((valor == "Métodos") || (valor == " Metodos") || (valor == "metodos") || (valor == "métodos?")) {
    ...
    else if ((valor == "pacotes") || (valor == "Pacotes")) {
        texto.innerHTML = "o que são pacotes na programação?";
        img.setAttribute("src", "img/pacotes");
        img.setAttribute("width", "80px");
    ...
    else if ((valor == "Enumeração") || (valor == "enumeracao")) {
    ...
    else if ((valor == "Serialização de objetos") || (valor == "serialização de objetos")) {
    ...
    else if ((valor == "Relacionamento de objetos?") || (valor == "relacionamento de objetos")) {
